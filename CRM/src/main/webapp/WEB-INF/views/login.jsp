...
<body id="login" class="animated fadeInDown">
			...
			<div class="row">
				<div
					...
					<div class="hero">
						<div class="pull-left login-desc-box-l">
							<h4 class="paragraph-header">CRM（Customer Relationship
								Management）。企业利用相应的信息技术以及互联网技术来协调企业与顾客间在销售、营销和服务上的交互，从而提升其管理方式，向客户提供创新式的个性化的客户交互和服务的过程。</h4>
							<hr>
				...
				<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
					<div class="well no-padding">
						<form action="${ctx }/dologin" method="post" id="login-form"
							class="smart-form">
							<header> 系统登录 </header>
								...
								<section>
									<label class="label">登录名</label> <label class="input">
										...
										name="username"> <b class="tooltip tooltip-top-right"><i
											class="fa fa-user txt-color-teal"></i> 请输入登录名</b>
									</label>
								</section>

								<section>
									<label class="label">登录密码</label> <label class="input">
										<i class="icon-append fa fa-lock"></i> <input type="password"
										name="password"> <b class="tooltip tooltip-top-right"><i
											class="fa fa-lock txt-color-teal"></i> 请输入登录密码</b>
									</label>
								</section>
								<div class="row">
									<section class="col col-md-6">
										<label class="label">验证码</label> <label class="input">
											<input type="text" id="captchaValue" name="captcha">
										</label>
										<div class="note">
											<br>
										</div>
									...
									<section class="col col-md-6">
										<label class="label login-label">&nbsp;</label> <label
											class="input"> <img class="login-captcha"
											id="captcha" alt="验证码" onclick="changeCaptcha()">
										</label>
									</section>
								</div>
	...
	<script
		src="${ctx}/assets/plugins/jquery-validate/jquery.validate.min.js"></script>
