...
<!-- 选择供应商窗口 -->
<div class="modal fade" id="selectSupplierModal" tabindex="-1"
...
<div class="widget">
	...
	<div id="purchaseOrderPanel" role="content">
		<div class="widget-body no-padding">
			<form method="post" id="purchaseOrderForm" name="purchaseOrder"
				class="smart-form" onSubmit="return false;">
				<input id="purchaseOrderId" type="hidden" name="id"
					value="${purchaseOrderModel.id }" /> <input name="createTime"
					type="hidden" value="${purchaseOrderModel.createTime }" />
				<fieldset>
					<div class="row">
						<section class="col col-md-6">
							<label class="label">主题</label> <label class="input"> <input
								name="theme" value="${purchaseOrderModel.theme }" type="text"
								data-rule="required;">
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">采购订单编号</label> <label class="input">
								...
								value="${purchaseOrderModel.code }" placeholder="自动生成销售订单编号"
								readonly="readonly">
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">负责人</label> <label class="select"> <input
								type="hidden" id="userCode"
								value="${purchaseOrderModel.user.id }"> <select
						...
						<section class="col col-md-6">
							<label class="label">承运单位</label> <label class="select">
								...
								value="${purchaseOrderModel.freight.code }"> <select
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">选择供应商</label> <label class="input">
								<input class="supplier-id" name="supplier.id"
								value="${purchaseOrderModel.supplier.id }" type="hidden" /> <input
								class="supplier-select" name="supplierName" readonly="readonly"
								value="${purchaseOrderModel.supplier.name }" type="text"
								data-rule="required" placeholder="点击选择供应商" />
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">联系人姓名</label> <label class="input">
								<input name="contactName"
								value="${purchaseOrderModel.contactName }" type="text"
								data-rule="required;">
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">联系人电话</label> <label class="input">
								...
								value="${purchaseOrderModel.contactPhone }" type="text"
								data-rule="required;">
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">销售订单状态</label> <label class="select">
								...
								value="${purchaseOrderModel.status.code }"> <select
					...
					<div class="row">
						<section class="col col-md-12">
							<label class="label">说明信息</label> <label class="input"> <textarea
									...
									maxlength="1500">${purchaseOrderModel.instruction }</textarea>
							</label>
						</section>
					</div>
					<div class="row">
						<section class="col col-4">
							...
							<button
								class="save-purchaseorder-btn btn btn-danger order-button"
								type="button">保存</button>
							<button
								class="cancel-purchaseorder-btn btn btn-default  order-button"
