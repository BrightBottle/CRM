...
<!-- 关联角色编辑窗口-->
<div class="modal fade" id="relateRoleModal" tabindex="-1"
	department="dialog" aria-hidden="true">
	<div class="modal-dialog">
			...
			<div class="widget">
				<div>
					<div class="widget-body-toolbar">
						<button class="add-department-btn btn btn-primary pull-left"
							type="button">
							<i class="fa fa-plus"></i> 新增
						</button>
						<input class="form-control list-search" name="name" id="name"
							placeholder="部门名..." type="text">
						<button class="search-department-btn btn btn-success"
							type="button">
        ...
        departmentTable = $qingshixun.dataTable($('#departmentTable'), {
            ...
            "columnDefs" : [ {
                ...
                "defaultContent" : "<button type='button' title='修改' class='btn btn-primary btn-xs edit'>" + "<i class='fa fa-pencil'></i>" + "</button>" + "&nbsp;&nbsp;" 
                	...
                	+ "<button type='button' title='添加角色' class='btn btn-primary btn-xs add'>"
