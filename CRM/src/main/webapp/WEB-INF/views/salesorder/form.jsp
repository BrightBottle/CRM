...
<div class="modal fade" id="selectCustomerModal" tabindex="-1"
	department="dialog" aria-hidden="true">
...
<!-- 选择销售机会窗口 -->
<div class="modal fade" id="selectOpportunityModal" tabindex="-1"
	department="dialog" aria-hidden="true">
	<div class="modal-dialog modal-product">
...
<!-- 选择产品窗口 -->
<div class="modal fade" id="selectProModal" tabindex="-1"
	department="dialog" aria-hidden="true">
	<div class="modal-dialog modal-product">
...
<!-- 选择报价单窗口 -->
<div class="modal fade" id="selectQuotationModal" tabindex="-1"
	department="dialog" aria-hidden="true">
	<div class="modal-dialog modal-product">
...
<div class="widget">
	...
	<div id="salesOrderPanel" role="content">
		<div class="widget-body no-padding">
			<form method="post" id="salesOrderForm" name="salesOrder"
				class="smart-form" onSubmit="return false;">
				<input id="salesOrderId" type="hidden" name="id"
					value="${salesOrderModel.id }" /> <input name="createTime"
					type="hidden" value="${salesOrderModel.createTime }" />
				<fieldset>
					<div class="row">
						<section class="col col-md-6">
							<label class="label">主题</label> <label class="input"> <input
								name="theme" value="${salesOrderModel.theme }" type="text"
								data-rule="required;">
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">销售订单编号</label> <label class="input">
								<input type="text" name="code" value="${salesOrderModel.code }"
								placeholder="自动生成销售订单编号" readonly="readonly">
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">负责人</label> <label class="select"> <input
								type="hidden" id="userCode" value="${salesOrderModel.user.id }">
						...
						<section class="col col-md-6">
							<label class="label">承运单位</label> <label class="select">
								<input type="hidden" id="freightCode"
								value="${salesOrderModel.freight.code }"> <select
								name="freight.code" id="freight">
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">选择销售机会</label> <label class="input">
								<input class="opportunity-id" name="opportunity.id"
								value="${salesOrderModel.opportunity.id }" type="hidden" /> <input
								class="opportunity-select" name="opportunityName"
								readonly="readonly" value="${salesOrderModel.opportunity.name }"
								type="text" data-rule="required" placeholder="点击选择销售机会" />
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">销售订单状态</label> <label class="select">
								<input type="hidden" id="statusCode"
								value="${salesOrderModel.status.code }"> <select
								name="status.code" id="status">
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">选择客户</label> <label class="input"> <input
								class="customer-id" name="customer.id"
								value="${salesOrderModel.customer.id }" type="hidden" /> <input
								class="customer-select" name="customerName" readonly="readonly"
								value="${salesOrderModel.customer.name }" type="text"
								data-rule="required" placeholder="点击选择客户" />
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">选择联系人</label> <label class="input">
								<input class="contact-id" name="contact.id"
								value="${salesOrderModel.contact.id }" type="hidden" /> <input
								class="contact-select" name="contactName" readonly="readonly"
								value="${salesOrderModel.contact.name }" type="text"
								data-rule="required" placeholder="点击选择联系人" />
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">选择报价单</label> <label class="input">
								<input class="quotation-id" name="quotation.id"
								value="${salesOrderModel.quotation.id }" type="hidden" /> <input
								class="quotation-select" name="quotationName"
								readonly="readonly" value="${salesOrderModel.quotation.title }"
								type="text" data-rule="required" placeholder="点击选择报价单" />
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">付款地址</label> <label class="input"> <textarea
									class="form-control description" rows="3" name="payAddress"
									maxlength="1500">${salesOrderModel.payAddress }</textarea>
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">送货地址</label> <label class="input"> <textarea
									class="form-control description" rows="3" name="receiveAddress"
									maxlength="1500">${salesOrderModel.receiveAddress }</textarea>
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-12">
							<label class="label">说明信息</label> <label class="input"> <textarea
									class="form-control description" rows="3" name="instruction"
									maxlength="1500">${salesOrderModel.instruction }</textarea>
							</label>
						</section>
					</div>
					<div class="row">
						<section class="col col-4">
							<button class="product-select-btn btn btn-primary order-button"
								type="button">选择产品</button>
							<button
								class="save-salesorder-btn save-btn btn btn-danger order-button"
								type="button">保存</button>
							<button
								class="cancel-salesorder-btn btn btn-default order-button"
