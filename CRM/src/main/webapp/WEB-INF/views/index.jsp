...
<link rel="stylesheet" type="text/css" media="screen"
	href="${ctx}/assets/plugins/bootstrap/bootstrap.min.css">
...
<link rel="stylesheet" type="text/css" media="screen"
	href="${ctx}/assets/plugins/jquery-confirm/jquery-confirm.min.css">

<!-- 基于bootstrap的提示框架 -->
<link rel="stylesheet" type="text/css" media="screen"
	href="${ctx}/assets/plugins/bootstrap-toastr/toastr.min.css">

<!-- 自定义css样式文件 -->
<link href="${ctx}/assets/plugins/jstree/themes/default/style.min.css"
	rel="stylesheet" />

<!-- jquery拖动排序插件样式文件 -->
<link rel="stylesheet" type="text/css"
	href="${ctx}/assets/plugins/nestable/jquery.nestable.css" />
...
<body class="index-body fixed-header fixed-ribbon fixed-navigation">
	...
	<header id="header">
		...
		<div id="logo-group">
			...
			<!-- 导航栏 -->
			<span title="导航" id="activity" class="activity-dropdown"> <i
			...
			<div class="ajax-dropdown">
				...
				<div class="btn-group btn-group-justified" data-toggle="buttons">
					<label class="btn btn-default"> <input type="radio"
						name="activity" url="index/navigation/business"> 商机导航
					</label> <label class="btn btn-default"> <input type="radio"
						name="activity" url="index/navigation/menu"> 所有菜单
					</label>
				</div>
		...
		<div id="buttons" class="pull-right">
			...
			<div id="logout" class="btn-header transparent pull-right">
				<span> <a href="${ctx }/logout" title="退出系统"
					data-logout-msg="是否确认退出系统？"> <i class="fa fa-sign-out"></i>
				</a>
				</span>
			</div>
			...
			<div id="fullscreen" class="btn-header transparent pull-right">
				<span> <a href="javascript:void(0);"
					...
					title="Full Screen"> <i class="fa fa-fullscreen"></i>
				</a>
				</span>
			</div>
		</div>
	...
	<aside id="left-panel">
		<nav>
			<ul>
				<!-- 首页 -->
				<li class="dashboard"><a href="dashboard/" title="Dashboard">
						<i class="fa fa-lg fa-fw fa-home"></i> <span
						class="menu-item-parent">统计分析</span>
				</a></li>
				...
				<c:forEach var="topMenu" items="${userMenus}">
					...
					<li class="sub-menu"><a href="#"> <i
							class="${topMenu.icon }"></i> <span class="menu-item-parent">${topMenu.name }</span>
					</a> <!-- 二级菜单 -->
						<ul class="sub">
	...
	<script
		src="${ctx}/assets/plugins/jquery-confirm/jquery-confirm.min.js"></script>
