...
<div class="widget">
	...
	<div id="quotationPanel" role="content">
		<div class="widget-body no-padding">
			<form method="post" id="quotationForm" name="quotation"
				class="smart-form" onSubmit="return false;">
				<input class="quotation-id" type="hidden" name="id"
					value="${quotationModel.id }" /> <input name="createTime"
					type="hidden" value="${quotationModel.createTime }" />
				<fieldset>
					<div class="row">
						<section class="col col-md-6">
							<label class="label">标题</label> <label class="input"> <input
								name="title" value="${quotationModel.title }" type="text"
								data-rule="required;">
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">报价单编号</label> <label class="input">
								<input type="text" name="code" value="${quotationModel.code }"
								placeholder="自动生成报价单编号" readonly="readonly">
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">负责人</label> <label class="select"> <input
								type="hidden" id="userCode" value="${quotationModel.user.id }">
						...
						<section class="col col-md-6">
							<label class="label">承运单位</label> <label class="select">
								...
								value="${quotationModel.freight.code }"> <select
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">选择销售机会</label> <label class="input">
								...
								value="${quotationModel.opportunity.id }" type="hidden" /> <input
								class="opportunity-select" name="opportunityName"
								readonly="readonly" value="${quotationModel.opportunity.name }"
						...
						<section class="col col-md-6">
							<label class="label">报价单状态</label> <label class="select">
								...
								value="${quotationModel.status.code }"> <select
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">选择客户</label> <label class="input"> <input
								...
								value="${quotationModel.customer.id }" type="hidden" /> <input
								class="customer-select" name="customerName" readonly="readonly"
								value="${quotationModel.customer.name }" type="text"
						...
						<section class="col col-md-6">
							<label class="label">选择联系人</label> <label class="input">
								...
								value="${quotationModel.contact.id }" type="hidden" /> <input
								class="contact-select" name="contactName" readonly="readonly"
								value="${quotationModel.contact.name }" type="text"
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">发票地址</label> <label class="input"> <textarea
									class="form-control description" rows="3" name="invoiceAddress"
									maxlength="1500">${quotationModel.invoiceAddress }</textarea>
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">送货地址</label> <label class="input"> <textarea
									class="form-control description" rows="3"
									name="receiverAddress" maxlength="1500">${quotationModel.receiverAddress }</textarea>
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-12">
							<label class="label">描述</label> <label class="input"> <textarea
									class="form-control description" rows="3" name="description"
									maxlength="1500">${quotationModel.description }</textarea>
							</label>
						</section>
					</div>
					<div class="row">
						<section class="col col-4">
							...
							<button class="save-quotation-btn btn btn-danger order-button"
								type="button">保存</button>
							<button class="btn btn-default cancel-quotation-btn order-button"
