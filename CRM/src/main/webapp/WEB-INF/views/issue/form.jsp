...
<div class="widget">
	...
	<div role="content">
		<div id="issuePanel" class="widget-body no-padding">
			<form method="post" id="issueForm" name="issue" class="smart-form"
				onSubmit="return false;">
				<input type="hidden" name="id" value="${issueModel.id }" /> <input
					name="createTime" type="hidden" value="${issueModel.createTime }" />
				<fieldset>
					<div class="row">
						<section class="col col-md-6">
							<label class="label">标题</label> <label class="input"> <input
								name="title" value="${issueModel.title }" type="text"
								data-rule="required;" maxlength="50">
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">问题单编号</label> <label class="input">
								<input type="text" name="code" value="${issueModel.code }"
								placeholder="自动生成问题单编号" readonly="readonly">
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">负责人</label> <label class="select"> <input
								type="hidden" id="userCode" value="${issueModel.user.id }">
						...
						<section class="col col-md-6">
							<label class="label">选择产品</label> <label class="input"> <input
								class="product-id" name="product.id"
								value="${issueModel.product.id }" type="hidden" /> <input
								class="product-select" name="productName" readonly="readonly"
								value="${issueModel.product.name }" type="text"
								data-rule="required" maxlength="100" placeholder="点击选择产品" />
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">选择联系人</label> <label class="input">
								...
								value="${issueModel.contact.id }" type="hidden" /> <input
								class="contact-select" name="contactName" readonly="readonly"
								value="${issueModel.contact.name }" type="text"
								data-rule="required" placeholder="点击选择联系人" />
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">优先级</label> <label class="select"> <input
								type="hidden" id="priorityCode"
								value="${issueModel.priority.code }"> <select
								name="priority.code" id="priority">
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">状态</label> <label class="select"> <input
								type="hidden" id="statusCode" value="${issueModel.status.code }">
					...
					<div class="row">
						<section class="col col-md-12">
							<label class="label">描述</label> <label class="input"> <textarea
									...
									maxlength="1500">${issueModel.description }</textarea>
							</label>
						</section>
					</div>
				</fieldset>
				<footer>
					<button type="submit" name="submit"
						class="save-issue-btn btn btn-primary">保存</button>
