...
<div class="widget">
	...
	<div role="content">
		<div id="campaignPanel" class="widget-body no-padding">
			<form method="post" id="campaignForm" name="campaign"
				class="smart-form" onSubmit="return false;">
				<input type="hidden" name="id" value="${campaignModel.id }" /> <input
					name="createTime" type="hidden"
					value="${campaignModel.createTime }" />
				<fieldset>
					<div class="row">
						<section class="col col-md-6">
							<label class="label">营销活动名称</label> <label class="input">
								<input name="name" value="${campaignModel.name }" type="text"
								data-rule="required;">
							</label>
						</section>
						<section class="col col-md-6">
							<label class="label">营销活动编号</label> <label class="input">
								<input type="text" name="code" value="${campaignModel.code }"
								placeholder="自动生成营销活动编号" readonly="readonly">
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">负责人</label> <label class="select"> <input
								type="hidden" id="userCode" value="${campaignModel.user.id }">
						...
						<section class="col col-md-6">
							<label class="label">营销活动状态</label> <label class="select">
								...
								value="${campaignModel.status.code }"> <select
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">营销活动类型</label> <label class="select">
								...
								value="${campaignModel.type.code }"> <select
								name="type.code" id="type">
						...
						<section class="col col-md-6">
							<label class="label">选择产品</label> <label class="input"> <input
								...
								value="${campaignModel.product.id }" type="hidden" /> <input
								class="product-select" name="productName" readonly="readonly"
								value="${campaignModel.product.name }" type="text"
					...
					<div class="row">
						<section class="col col-md-6">
							<label class="label">发送数量</label> <label class="input"> <input
								type="text" name="quantity" value="${campaignModel.quantity }"
						...
						<section class="col col-md-6">
							<label class="label">预计结束日期:</label> <label class="input">
								...
								value="${campaignModel.endDate }" data-rule="required">
							</label>
						</section>
					</div>
					...
					<div class="row">
						<section class="col col-md-12">
							<label class="label">说明信息</label> <label class="input"> <textarea
									...
									maxlength="1500">${campaignModel.instruction }</textarea>
							</label>
						</section>
					</div>
				</fieldset>
				<footer>
					<button type="submit" name="submit"
						class="save-campaign-btn btn btn-primary">保存</button>
