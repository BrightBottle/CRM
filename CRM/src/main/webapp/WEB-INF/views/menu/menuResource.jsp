	...
	<div class="row">
		<div class=" address">
			<div class="contact-form">
				<form id="menu-resource-form" name="menu" role="form"
					onSubmit="return false;">
					<input type="hidden" name="menuId" value="${resourceModel.menuId }" />
					<input type="hidden" name="id" value="${resourceModel.id }" />
					<div class="row">
						<div class="form-group col-md-4">
							<label for="name">资源名称：</label> <input class="form-control"
								name="name" value="${resourceModel.name }" data-rule="required"
								placeholder="请输入资源名称..." maxlength="50" />
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-4">
							<label for="email">资源URL：</label> <input class="form-control"
								name="url" value="${resourceModel.url }" data-rule="required"
