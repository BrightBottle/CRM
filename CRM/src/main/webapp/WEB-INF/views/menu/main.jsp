								...
								<c:forEach var="item" items="${menuTreeData}">
									<li class="dd-item dd3-item" data-id="${item.id }">
										...
										<div class="dd3-content">${item.name }<div
												...
												<a class="menu-edit-btn blue" href="#" target="${item.id }">
													<i class="fa fa-pencil"></i>
												</a> <a class="menu-add-btn blue" href="#" target="${item.id }">
													<i class="fa fa-plus"></i>
												</a> <a class="menu-remove-btn red" href="#"
													target="${item.id }"> <i class="fa fa-minus"></i>
												</a>
											</div>
										</div>
										...
										<ol class="dd-list">
											<c:forEach var="citem_1" items="${item.children}">
												<li class="dd-item dd3-item" data-id="${citem_1.id }">
													<div class="dd-handle dd3-handle"></div>
													<div class="dd3-content">${citem_1.name }<div
															class="pull-right action-buttons">
															<a class="menu-edit-btn blue" href="#"
																target="${citem_1.id }"> <i class="fa fa-pencil"></i>
															</a> <a class="menu-remove-btn red" href="#"
																target="${citem_1.id }"> <i class="fa fa-minus"></i>
															</a>
														</div>
													</div>
												</li>
