					...
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('campaign',${campaign.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'campaign',${campaign.id })">
			...
			<tbody>
				<c:forEach items="${prospectiveList }" var="prospective">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('prospective',${prospective.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'prospective',${prospective.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
			...
			<tbody>
				<c:forEach items="${customerList }" var="customer">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('customer',${customer.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'customer',${customer.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
			...
			<tbody>
				<c:forEach items="${contactList }" var="contact">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('contact',${contact.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'contact',${contact.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
			...
			<tbody>
				<c:forEach items="${opportunityList }" var="opportunity">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('opportunity',${opportunity.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'opportunity',${opportunity.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
			...
			<tbody>
				<c:forEach items="${quotationList }" var="quotation">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('quotation',${quotation.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'quotation',${quotation.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
			...
			<tbody>
				<c:forEach items="${salesOrderList }" var="salesOrder">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('salesOrder',${salesOrder.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'salesOrder',${salesOrder.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
			...
			<tbody>
				<c:forEach items="${issueList }" var="issue">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('issue',${issue.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'issue',${issue.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
			...
			<tbody>
				<c:forEach items="${problemList }" var="problem">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('problem',${problem.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'problem',${problem.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
				...
				<c:forEach items="${productList }" var="product">
					<tr>
						...
						<td><img style="width: 50px; height: 50px;"
							src="${imagePath }${product.picture }"></td>
						<td>${product.status.name }</td>
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('product',${product.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'product',${product.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
			...
			<tbody>
				<c:forEach items="${supplierList }" var="supplier">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('supplier',${supplier.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'supplier',${supplier.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
			...
			<tbody>
				<c:forEach items="${purchaseOrderList }" var="purchase">
					<tr>
						...
						<td>
							<button title="修改" class="btn btn-primary btn-xs"
								onclick="goEdit('purchaseOrder',${purchase.id })">
								<i class="fa fa-pencil"></i>
							</button>
							<button title="删除" class="btn btn-danger btn-xs"
								onclick="doDelete(this,'purchaseOrder',${purchase.id })">
								<i class="fa fa-trash-o"></i>
							</button>
						</td>
					</tr>
