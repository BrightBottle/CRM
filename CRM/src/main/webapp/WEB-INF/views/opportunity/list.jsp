			...
			<div class="widget ">
				<div>
					<div class="widget-body-toolbar">
						<button class="add-opportunity-btn btn btn-primary pull-left"
							type="button">
							<i class="fa fa-plus"></i> 新增
						</button>
						<input class="form-control list-search" name="name" id="name"
							placeholder="销售机会名称" type="text">
						<button class="search-opportunity-btn btn btn-success"
							type="button">
							<i class="fa fa-search"></i>
						</button>
						<button class="reset-opportunity-btn btn btn-default"
							type="button">
					...
					<div class="widget-body no-padding">
						<table id="opportunityTable"
							class="table table-striped table-hover list-table">
							<thead>
								<tr>
									<th>销售机会编号</th>
									<th>名称</th>
