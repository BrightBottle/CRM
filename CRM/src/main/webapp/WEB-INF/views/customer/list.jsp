	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<label>导出文件名称:</label><input type="text" class="file form-control"
					maxlength="100" />
			</div>
						...
						<div class="widget-body-toolbar">
							<div class="row">
								<div class="col-md-5">
									...
									<button class="excel-customer-btn btn btn-default"
										type="button">
										<i class="fa fa-folder-open-o"></i> 导出
									</button>
								</div>
								<div class="col-md-7">
									<input class="form-control list-search-contact" name="name"
										id="name" placeholder="客户名..." type="text">
									<button class="search-customer-btn btn btn-success"
										type="button">
										<i class="fa fa-search"></i>
									</button>
									<button class="reset-customer-btn btn btn-default"
										type="button">
