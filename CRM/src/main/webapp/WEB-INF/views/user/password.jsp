...
<div class="modal-body">
	<form id="updatePasswordForm" method="post">
		...
		<div class="form-group">
			<label for="roleName">输入新密码:</label> <input name="password"
				type="password" class="form-control" data-rule="required"
				maxlength="100" placeholder="请输入密码..." />
		</div>
		<div class="form-group">
			<label for="roleName">再次输入新密码:</label> <input name="passwordAgain"
				type="password" class="form-control" data-rule="required"
				maxlength="100" placeholder="请再次输入密码..." />
		</div>
	</form>
</div>
