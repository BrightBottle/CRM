...
<div class="widget">
	...
	<div role="content">
		<div class="widget-body no-padding">
			<form novalidate="novalidate" action="#" method="post" id="userForm"
				class="smart-form">
				<input type="hidden" id="userId" name="id" value="${userModel.id }" />
				<input type="hidden" id="genderId" value="${userModel.gender }" />
				<input name="createTime" type="hidden"
					value="${userModel.createTime }" /> <input name="status.code"
					type="hidden" value="${userModel.status.code }" />
				<fieldset>
					<div class="row">
						<section class="col col-4">
							<label class="label">登录名</label> <label class="input"> <input
								name="loginName" value="${userModel.loginName }"
								data-rule="required" type="text" maxlength="50">
							</label>
						</section>
						<section class="col col-4">
							<label class="label">用户名</label> <label class="input"> <input
								type="text" value="${userModel.name }" data-rule="required"
								name="name" maxlength="50">
							</label>
						</section>
						<section id="password" class="col col-4">
							<label class="label">密码</label> <label class="input"> <input
								type="password" value="${userModel.password }"
								data-rule="required" name="password" maxlength="20">
							</label>
						</section>
					</div>
					<div class="row">
						<section class="col col-4">
							<label class="label">邮箱</label> <label class="input"> <input
								type="email" name="email" value="${userModel.email }"
								data-rule="required; email;">
							</label>
						</section>
						<section class="col col-4">
							<label class="label">电话</label> <label class="input"> <input
								type="text" name="phone" value="${userModel.phone }"
